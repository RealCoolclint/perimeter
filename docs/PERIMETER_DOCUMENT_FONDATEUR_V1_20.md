...
*Version 1.20 — 26 septembre 2026*
...
- **Passer l'app OAuth Google en statut « In production »** (Google Cloud Console › OAuth consent screen › Publish app) pour arrêter l'expiration des credentials Calendar et Gmail tous les 7 jours — usage personnel, pas de vérification Google requise (avertissement « app non vérifiée » acceptable).
