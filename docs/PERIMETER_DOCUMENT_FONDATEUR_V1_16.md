...
*Version 1.16 — 20 septembre 2026*
...
- **Construire le pipeline n8n de lecture Boîte mail (D48/D71-D74)** — condition pour que le moteur Ollama (D51/D57-D68) couvre les azimuts Boîte mail, Finances perso, et la partie mail de Loisirs/Domicile, aujourd'hui seulement câblés côté Calendrier. Bloqué côté Outlook en attendant qu'un administrateur du tenant L'Étudiant (Florian ou Wagner) accorde le consentement sur l'app "Perimeter Outlook Sync" (D74, email envoyé le 19/09/2026) ; la branche Gmail perso (credential à créer) n'est pas bloquée et peut être construite indépendamment dès la prochaine session.
