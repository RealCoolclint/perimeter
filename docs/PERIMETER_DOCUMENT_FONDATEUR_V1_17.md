...
*Version 1.17 — 20 septembre 2026*
...
- **Fenêtre de lecture Gmail (D72)** — remonte tout le backlog de non-lus, pas seulement les mails récents (42 messages vus lors d'un test, remontant à plusieurs jours). Trois options en discussion : fenêtre glissante sur le non-lu (ex. 48h), champ d'ancienneté traité différemment par Ollama, ou cap strict en nombre sans logique temporelle. D72 reste la décision de principe actée (mails du jour OU non-lus) ; ce qui est rouvert, c'est le paramétrage de la fenêtre sur le non-lu (durcir à une fenêtre glissante, ou traiter différemment un non-lu ancien), pas le principe lui-même. Décision à prendre à la prochaine session.
