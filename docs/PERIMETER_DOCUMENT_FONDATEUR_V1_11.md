...
- Construire le pipeline n8n de lecture effective du calendrier Outlook comme deuxième source (D16) — la connexion OAuth2 elle-même est validée (D45), reste la logique métier et la conversion UTC → Europe/Paris
