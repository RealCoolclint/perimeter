...
- Suivi Présentiel/TT (D33) : gestion de la rotation annuelle du board au 8 octobre (bascule d'une saison à l'autre non construite) ; déclenchement automatique du workflow (D5, encore manuel). Affinage des jours non confirmés traité en D41/D42 — ne reste que le jour du 22/09/2026, en attente du tournage.
